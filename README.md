...
See `growth\\\_opportunity\\\_score\\\_chart.png` — bars colored by basket, with the Adani Green / Tata Power anomaly annotated directly on the chart.
...
See `green\\\_basket\\\_forecast.png` and `grey\\\_basket\\\_forecast.png`.
Risk Summary
